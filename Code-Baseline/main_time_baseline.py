...
from retrieval_augmented_generation_baseline import *
from rewriter import Rewriter
import pickle
import pandas as pd

def main_time_baseline():
  ...
  ret_type = RetrieverType.PAGE_CHUNK_BASIC_RET
  parmaters = (3000,750,0,0,0,2)
  ...
  result_df.to_excel(f"Answered-Baseline-Timed.xlsx", index=False)
